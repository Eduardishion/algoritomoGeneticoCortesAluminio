...
package procedimientos.metodosDecimales.extras;
 ...
 * @author Peter Tran
 */
public class OX implements Path_Crossover
{
    private int[] parent1;
    private int[] parent2;
    ...
    public OX(int [] parent1, int [] parent2){
        ...
        int numeroDeGenes = parent1.length;
        ...
        cutPoint1 = puntoDecorte1;
        cutPoint2 = puntoDecorte2;
        */
        //-----
        ...
        System.out.println("P1:"+cutPoint1);
        System.out.println("P2:"+cutPoint2);
